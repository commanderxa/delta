use crate::{Tensor, tensor_impl::TensorImpl};
...
pub fn eye(n: usize) -> Tensor {
    ...
    let inner = TensorImpl::from_f64(array);
    Tensor::new(inner, shape)
}
...
pub fn arange(start: f64, end: f64, step: f64) -> Tensor {
    ...
    let inner = TensorImpl::from_f64(data);
