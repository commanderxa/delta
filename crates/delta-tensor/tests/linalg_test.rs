#[cfg(test)]
mod tests {
    use delta_tensor::{Tensor, get_default_dtype, linalg};
    ...
    #[test]
    fn cross_1d() {
        let a = delta_tensor::tensor(&[0.6, -20.5, 5.8], &[3], delta_tensor::cpu);
        let b = delta_tensor::tensor(&[10.2, -4.6, -34.], &[3], delta_tensor::cpu);
    ...
    #[test]
    fn cross_multidim() {
        let a = delta_tensor::ones(&[3, 2, 3, 2, 2, 3], get_default_dtype(), delta_tensor::cpu);
        let b = delta_tensor::tensor(
            &[
        ...
        let c = delta_tensor::linalg::cross(a.clone(), b.clone());
        let correct = vec![
    ...
    #[test]
    fn mul_scalar_2d() {
        let a = delta_tensor::arange(1., 11., 1.0, delta_tensor::float64, delta_tensor::cpu);
        let a = a.reshape(&[2, 5]);
        let b = 5 as i32;
        let c = a * b;
        assert_eq!(
    ...
    #[test]
    fn mul_scalar_3d() {
        let a = delta_tensor::arange(1., 13., 1.0, delta_tensor::float64, delta_tensor::cpu);
    ...
    #[test]
    fn div_scalar_2d() {
        let a = delta_tensor::arange(1., 61., 10., delta_tensor::float64, delta_tensor::cpu);
        let a = a.reshape(&[2, 3]);
        let b: i32 = 5;
        let c = a / b;
    ...
    #[test]
    fn div_scalar_3d() {
        let a = delta_tensor::arange(1., 13., 1., delta_tensor::float64, delta_tensor::cpu);
        let a = a.reshape(&[2, 2, 3]);
        let b: i32 = 5;
        let c = a / b;
        assert_eq!(
    ...
    #[test]
    fn add_1d_and_1d() {
        let a = delta_tensor::arange(0., 11., 1., delta_tensor::float64, delta_tensor::cpu);
        let b = delta_tensor::arange(0., 11., 1., delta_tensor::float64, delta_tensor::cpu);
        let c = a + b;
        assert_eq!(
            c.data::<f64>(),
